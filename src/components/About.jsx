...
const About = () => {
  ...
  return (
    ...
    <div name="sobre mi" className="w-full h-full lg:h-screen bg-gradient-to-b from-gray-800 to-black text-white">
        ...
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
            ...
            <p className="text-xl leading-8 tracking-wide font">
                ...
                un extenso curso sobre Desarrollo Web Full Stack certificado por el 
